    ...
    <div id="wrapper">
        <div class="header-wrapper">
                        ...
                        <div class="col-xs-8  col-sm-10 header-info">
                            <div class="col-xs-12 menu-area">
                                ...
                                <ul>
                                    ...
                                    @endif
                                    <span class="language">
                                        <li class="{{ Request::segment(1) == 'ru' ? "active" : "" }}"> <a href="/ru/blog/{{ Request::segment(3) }}" class="uk-text-uppercase"> <img src="{{ asset('front-assets/img/ru.png') }}"> </a></li>
                                        <li class="{{ Request::segment(1) == 'ro' ? "active" : "" }}"><a href="/ro/blog/{{ Request::segment(3) }}" class="uk-text-uppercase"> <img src="{{ asset('front-assets/img/ro.png') }}"> </a></li>
                                    </span>
                                </ul>
                            </div>
            ...
            <div class="container">
                <div class="row blog">
                    <div class="col-md-9">
                        <div class="post one-post row">
                            <div class="col-md-12 post-info">
                                {{-- <div class="keyword">{{ $article->h1_title }}</div> --}}
                                <h2><a>{{ $article->name }}</a></h2>
                                ...
                                <div class="post-body">
                                    <img src="/upfiles/info_line/{{ $article->infoItemId->img }}" alt="">
                                   {!! $article->body !!}
                                </div>
                                <div class="post-detail">
                                    <span class="author">de catre <b>Like Media</b></span>
                                ...
                                <a href="{{ url($lang.'/blog') }}" class="view-posts"><< {{ Label(11, $lang_id) }}</a>
